...
import { PublicToilet } from './public-toilet.entity';
import { User } from '../../users/entities/user.entity';
import { ScheduleFrequency, ScheduleStatus } from '../../maintenance/enums/maintenance.enums';

@Entity('public_toilet_maintenance_schedules')
export class PublicToiletMaintenance {
  ...
  @OneToMany(() => MaintenanceAttachment, (attachment) => attachment.publicToiletMaintenance, {
    cascade: true,
  })
