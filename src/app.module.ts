      ...
      useFactory: (configService: ConfigService) => {
        ...
        if (databaseUrl) {
          ...
          return {
            ...
            username: decodeURIComponent(String(parsedUrl.username)),
            password: decodeURIComponent(String(parsedUrl.password)),
            database: String(parsedUrl.pathname).replace(/^\//, ''),
          };
        }
        ...
        return {
          ...
          database: configService.get<string>('DB_NAME', 'smart_pole_dev'),
        };
      },
