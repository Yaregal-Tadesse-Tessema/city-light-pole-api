...
import { PublicPark } from './public-park.entity';
import { User } from '../../users/entities/user.entity';
import { ScheduleFrequency, ScheduleStatus } from '../../maintenance/enums/maintenance.enums';

@Entity('park_maintenance_schedules')
export class ParkMaintenance {
  ...
  @OneToMany(() => MaintenanceAttachment, (attachment) => attachment.parkMaintenance, {
    cascade: true,
  })
